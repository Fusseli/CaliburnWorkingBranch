...
namespace DOL.GS.Spells
{
    ...
    class CombineScrolls : SpellHandler
    {
        ...
        public override bool CheckBeginCast(GameLiving selectedTarget)
        {
			...
			DbInventoryItem scroll = player.UseItem;
        ...
        public override void OnDirectEffect(GameLiving target)
        {
            ...
            DbInventoryItem useItem = player.UseItem;
			...
			DbArtifact artifact = ArtifactMgr.GetArtifact(combinedScroll.Item);
			...
			if (player.ReceiveItem(player, combinedScroll))
                foreach (DbInventoryItem item in removeItems)
                {
