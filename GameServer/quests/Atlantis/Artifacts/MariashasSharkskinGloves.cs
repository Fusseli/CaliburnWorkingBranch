...
{
    /// <summary>
    /// Quest for the Mariasha's Sharkskin Gloves artifact.
    /// </summary>
    /// <author>Aredhel</author>
    public class MariashasSharkskinGloves : ArtifactQuest
    {
		...
		{
            ArtifactQuest.Init("Mariasha's Sharkskin Gloves", typeof(MariashasSharkskinGloves));
		}
		...
		public override bool WhisperReceive(GameLiving source, GameLiving target, string text)
		{
			...
			{
                String reply = String.Format("Mariasha's Sharkskin Gloves is an interesting gloves. The story of its {0} {1}",
		...
		public override string Description
		{
			get
			{
				...
				{
					case 1:
						return "Obtain the gloves; survive the sharks.";
					case 2:
