...
{
    /// <summary>
    /// Quest for the Traldor's Oracle artifact.
    /// </summary>
    /// <author>Aredhel</author>
    public class TraldorsOracle : ArtifactQuest
    {
		...
		{
            ArtifactQuest.Init("Traldor's Oracle", typeof(TraldorsOracle));
		}
		...
		public override bool WhisperReceive(GameLiving source, GameLiving target, string text)
		{
			...
			{
                String reply = String.Format("Traldor's Oracle is an interesting artifact. The story of its {0} {1}",
