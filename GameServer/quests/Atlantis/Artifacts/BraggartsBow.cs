...
{
    /// <summary>
    /// Quest for the Braggart's Bow artifact.
    /// </summary>
    /// <author>Aredhel</author>
    public class BraggartsBow : ArtifactQuest
    {
        public BraggartsBow()
			: base() { }
		...
		{
            ArtifactQuest.Init("Braggart's Bow", typeof(BraggartsBow));
		}
		...
		public override bool WhisperReceive(GameLiving source, GameLiving target, string text)
		{
			...
			{
                String reply = String.Format("Braggart's Bow is an interesting weapon. The story of its {0} {1}",
