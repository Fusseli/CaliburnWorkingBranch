...
{
    /// <summary>
    /// Quest for the Scepter of the Meritorious artifact.
    /// </summary>
    /// <author>Aredhel</author>
    public class ScepteroftheMeritorious : ArtifactQuest
    {
		...
		{
            ArtifactQuest.Init("Scepter of the Meritorious", typeof(ScepteroftheMeritorious));
		}
		...
		public override bool WhisperReceive(GameLiving source, GameLiving target, string text)
		{
			...
			{
                String reply = String.Format("Scepter of the Meritorious is an interesting weapon. The story of its {0} {1}",
					"making rather unique, don't you think? If you give me the scroll, I'll give you the",
					"scepter, with all its ancient powers back.");
				scholar.TurnTo(player);
				scholar.SayTo(player, eChatLoc.CL_PopupWindow, reply);
				Step = 2;
				return true;
