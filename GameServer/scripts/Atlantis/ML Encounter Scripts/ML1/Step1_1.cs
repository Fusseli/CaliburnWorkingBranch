//---------------------------------------------------------
//------------ Master Level 1.1 - Fire Island -------------
//-------------------Author : Bluraven---------------------
//------------- Rewrited : hibernos - 06/05/2011 ----------
...
namespace DOL.GS.Atlantis
{
    ...
    public class Ianetor : GameNPC
    {
        ...
        //Region ID
        public static ushort albregion = 73;
        public static ushort hibregion = 130;
        public static ushort midregion = 30;
        ...
        //Npc List
        public List<GameNPC> WallofFireList = new List<GameNPC>();
        public List<GameNPC> StairGuardList = new List<GameNPC>();
        public List<GameNPC> BossList = new List<GameNPC>(); //holds Sunkaio, Zopureo, and Aithos.
        public GameNPC Zop = null;
        public GameNPC Aith = null;
        public GameNPC Sun = null;
        public List<GameNPC> PurrosList = new List<GameNPC>();

        #region Array's, This contain all SpawnsLocs
        //Fire Position Array
        ...
        public override bool Interact(GamePlayer player) //MainDjinnInteractWhithPlayer
        {
        ...
        public override bool WhisperReceive(GameLiving source, string str) //WhispReceived
        {
        ...
        public override bool AddToWorld() //Add To World
        {
            ...
            //Spawn Other Ianetors
            if (this.CurrentRegionID == albregion)
            {
                SpawnIanetor2(albregion);
                log.Warn("Master Level - 1.1 - Other Ianetors ALB added.");
            }
            else if (this.CurrentRegionID == midregion)
            {
                SpawnIanetor2(midregion);
                log.Warn("Master Level - 1.1 - Other Ianetors MID added.");
            }
            else if (this.CurrentRegionID == hibregion)
            {
                SpawnIanetor2(hibregion);
                log.Warn("Master Level - 1.1 - Other Ianetors HIB added.");
            }

            return base.AddToWorld();
        }

        //Prevent Begin Encounter - Begin Encounter
        public bool BeginEncounter(GamePlayer player) //When player click on [begin]
        {
            ...
            //Set Progress state and Assign Region
            InProgress = true;
            playerregion = player.CurrentRegionID;

            //Timer to begin encounter
            new ECSGameTimer(this, new ECSGameTimer.ECSTimerCallback(ActivateEncounter), (60 * 1000));

            return true;
        }
        public int ActivateEncounter(ECSGameTimer timer)//60 seconds have passed since whispering 'begin' to Ianetor.
        {

            //Spawn Encounter
            SpawnEncounter();

            //Timer to DespawnEncounter if time elapsed
            new ECSGameTimer(this, new ECSGameTimer.ECSTimerCallback(DeSpawnEncounter), (900 * 1000)); //Despawn after 15 minutes, no matter what happens
            return 0;
        }
        
        //Spawn-DeSpawn Encounter
        public void SpawnIanetor2(int region) //Spawn Fake Ianetor
        {
            FakeIanetor ianetor2 = new FakeIanetor();
            ...
            ianetor2.Parent = this;
            ianetor2.AddToWorld();
        }
        public void SpawnEncounter() //Spawn Encounter
        {
        ...
        public void DeSpawnEncounter() //Despawn Encounter
        {
        ...
        public int DeSpawnEncounter(ECSGameTimer timer) //this one gets called if the 15 min timer runs out.
        {
            DeSpawnEncounter();
            return 0;
        }
        ...
        //Spawn's
        public void SpawnAfire(int fireX, int fireY, int fireZ) // Spawn a fire Guard
        {
        ...
        public void SpawnAGuard(int guardX, int guardY, int guardZ, ushort heading) //Spawn a Guard
        {
        ...
        {
            log.Warn("Master Level - 1.1 - Initializing Objects ...");
            #region Nedfall Entrapment Gem
            #region Base
            DbItemTemplate gem = (DbItemTemplate)GameServer.Database.FindObjectByKey<DbItemTemplate>("ToaManager_Nedfall_Entrapment_Gem");
            if (gem == null)
            {
                log.Warn("Master Level - 1.1 - Nedfall Entrapment Gem not Found ...");
                DbItemTemplate Nedfall_Entrapment_Gem = new DbItemTemplate();
                Nedfall_Entrapment_Gem.PackageID = "ToaManager001";
                Nedfall_Entrapment_Gem.Id_nb = "ToaManager_Nedfall_Entrapment_Gem";
                Nedfall_Entrapment_Gem.Name = "Nedfall Entrapment Gem";
                Nedfall_Entrapment_Gem.Level = 30;
                Nedfall_Entrapment_Gem.Durability = 50000;
                Nedfall_Entrapment_Gem.MaxDurability = 50000;
                Nedfall_Entrapment_Gem.Condition = 50000;
                Nedfall_Entrapment_Gem.MaxCondition = 50000;
                Nedfall_Entrapment_Gem.Quality = 85;
                Nedfall_Entrapment_Gem.DPS_AF = 0;
                Nedfall_Entrapment_Gem.SPD_ABS = 0;
                Nedfall_Entrapment_Gem.Hand = 0;
                Nedfall_Entrapment_Gem.Type_Damage = 0;
                Nedfall_Entrapment_Gem.Object_Type = 41;
                Nedfall_Entrapment_Gem.Item_Type = 24;
                Nedfall_Entrapment_Gem.Color = 0;
                Nedfall_Entrapment_Gem.Emblem = 0;
                Nedfall_Entrapment_Gem.Effect = 0;
                Nedfall_Entrapment_Gem.Weight = 3;
                Nedfall_Entrapment_Gem.Model = 118;
                Nedfall_Entrapment_Gem.Extension = 0;
                Nedfall_Entrapment_Gem.Bonus = 0;
                Nedfall_Entrapment_Gem.Bonus1 = 0;
                Nedfall_Entrapment_Gem.Bonus2 = 0;
                Nedfall_Entrapment_Gem.Bonus3 = 0;
                Nedfall_Entrapment_Gem.Bonus4 = 0;
                Nedfall_Entrapment_Gem.Bonus5 = 0;
                Nedfall_Entrapment_Gem.Bonus6 = 0;
                Nedfall_Entrapment_Gem.Bonus7 = 0;
                Nedfall_Entrapment_Gem.Bonus8 = 0;
                Nedfall_Entrapment_Gem.Bonus9 = 0;
                Nedfall_Entrapment_Gem.Bonus10 = 0;
                Nedfall_Entrapment_Gem.ExtraBonus = 0;
                Nedfall_Entrapment_Gem.Bonus1Type = 0;
                Nedfall_Entrapment_Gem.Bonus2Type = 0;
                Nedfall_Entrapment_Gem.Bonus3Type = 0;
                Nedfall_Entrapment_Gem.Bonus4Type = 0;
                Nedfall_Entrapment_Gem.Bonus5Type = 0;
                Nedfall_Entrapment_Gem.Bonus6Type = 0;
                Nedfall_Entrapment_Gem.Bonus7Type = 0;
                Nedfall_Entrapment_Gem.Bonus8Type = 0;
                Nedfall_Entrapment_Gem.Bonus9Type = 0;
                Nedfall_Entrapment_Gem.Bonus10Type = 0;
                Nedfall_Entrapment_Gem.ExtraBonusType = 0;
                Nedfall_Entrapment_Gem.IsPickable = false;
                Nedfall_Entrapment_Gem.IsDropable = true;
                Nedfall_Entrapment_Gem.CanDropAsLoot = false;
                Nedfall_Entrapment_Gem.IsTradable = false;
                Nedfall_Entrapment_Gem.MaxCount = 1;
                Nedfall_Entrapment_Gem.PackSize = 1;
                Nedfall_Entrapment_Gem.Charges = 0;
                Nedfall_Entrapment_Gem.MaxCharges = 0;
                Nedfall_Entrapment_Gem.Charges1 = 0;
                Nedfall_Entrapment_Gem.MaxCharges1 = 0;
                Nedfall_Entrapment_Gem.SpellID = 0;
                Nedfall_Entrapment_Gem.SpellID1 = 0;
                Nedfall_Entrapment_Gem.ProcSpellID = 0;
                Nedfall_Entrapment_Gem.ProcSpellID1 = 0;
                Nedfall_Entrapment_Gem.PoisonSpellID = 0;
                Nedfall_Entrapment_Gem.PoisonMaxCharges = 0;
                Nedfall_Entrapment_Gem.PoisonCharges = 0;
                Nedfall_Entrapment_Gem.Realm = 0;
                Nedfall_Entrapment_Gem.AllowedClasses = "";
                Nedfall_Entrapment_Gem.CanUseEvery = 0;
                //Nedfall_Entrapment_Gem.Flags = 0;
                //Nedfall_Entrapment_Gem.BonusLevel = 0;
                Nedfall_Entrapment_Gem.Description = "";
                ...
                Nedfall_Entrapment_Gem.Price = 0;
                //Nedfall_Entrapment_Gem.ProcChance = 0;
                Nedfall_Entrapment_Gem.ClassType = "";
                //Nedfall_Entrapment_Gem.SalvageYieldID = 0;
                GameServer.Database.AddObject(Nedfall_Entrapment_Gem);
                log.Warn("Master Level - 1.1 - Nedfall Entrapment Gem added !");
            }
            #endregion Base
            #region Update1
            //Update1
            #endregion
            #endregion Nedfall Entrapment Gem
            log.Warn("Master Level - 1.1 - Objects Initialized !");
            log.Warn("Master Level - 1.1 - Initializing Event...");
            if (Albion == true)
            {
                SpawnIanetor(albregion);
                log.Warn("Master Level - 1.1 - Main Ianetors ALB added.");
            }
            if (Midgard == true)
            {
                SpawnIanetor(midregion);
                log.Warn("Master Level - 1.1 - Main Ianetors MID added.");
            }
            if (Hibernia == true)
            {
                SpawnIanetor(hibregion);
                log.Warn("Master Level - 1.1 - Main Ianetors HIB added.");
            }
            log.Warn("Master Level - 1.1 - Event Initialized !");
        }

        public static void SpawnIanetor(int region) //Spawn Ianetor
        {
    ...
    public class FakeIanetor : GameNPC
    {
        ...
        //Overrides
        public override bool Interact(GamePlayer player) //OtherDjinnInteractWhithPlayer
        {
            if (base.Interact(player))
            {
                TurnTo(player, 1500);
    ...
    {        
        ...
        public override void TakeDamage(GameObject source, eDamageType damageType, int damageAmount, int criticalAmount)
        {
            ...
            foreach (GameNPC purro in Parent.PurrosList)
            {
                if (!purrosicked)
                {
                    ...
                    {
                        purro.attackComponent.AddAttacker(source as GameLiving);
        ...
        public void SpawnAPurro(int purroX, int purroY, int purroZ)
        {
            ...
            purro.Parent = this;
            purro.AddToWorld();
            Parent.PurrosList.Add(purro);
            return;

        }

        //Health Changed
        public void ZopureoChangeHealth(int damage)
        {

            if (Parent.Zop.IsAlive)
            {
                Parent.Zop.Health -= (int)Math.Round((decimal)damage / 2);
                if (Parent.Zop.Health <= 0)
                {
                    ...
                    Parent.PurrosList.Clear();
                    Parent.BossList.Remove(Parent.Zop);
                    Parent.Zop.Health = 0;
                    Parent.Zop.Die(Parent.Zop);
                    Parent.Zop.Delete();
                }
    ...
    class GamePurros : GameNPC
    {
        ...
        public override void Die(GameObject killer) //Die
        {
            Parent.ZopureoChangeHealth(this.MaxHealth);
            Parent.Parent.PurrosList.Remove(this);
            base.Die(killer);
        }
...
namespace DOL.GS.Atlantis
{
    ...
    public class ZopureoBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            ...
            if ((zbody.Parent.PurrosList.Count < 1) && (zbody.IsAlive))
            {
                zbody.SpawnPurros();
            }
            base.Think();
    ...
    public class PurroBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            ...
            {
                new ECSGameTimer(Body, new ECSGameTimer.ECSTimerCallback(PurroExplode), (5 * 1000));
                TimerOn = true;
            }

            base.Think();
        }
        public int PurroExplode(ECSGameTimer timer)
        {
            GamePurros pbody = Body as GamePurros;
            if (pbody.IsAlive && pbody.Health > 1)
            {
                int damageamount = (int)Math.Round((decimal)(pbody.MaxHealth - pbody.Health) / 2);
                pbody.Parent.ZopureoChangeHealth(damageamount);
